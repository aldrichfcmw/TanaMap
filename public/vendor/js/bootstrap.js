    ...
    return (function () {
        ...
        function W(e, t, n) {
            ...
            t &&
                ...
                (o =
                    (e.offsetHeight > 0 && F(i.height) / e.offsetHeight) || 1));
        ...
        function X(e) {
            for (
                var t = S(e), n = U(e);
                n && V(n) && "static" === q(n).position;

            )
                n = U(n);
            return n &&
                ("html" === x(n) ||
                    ("body" === x(n) && "static" === q(n).position))
                ? t
                : n ||
                      (function (e) {
                ...
                : ve(
                      (function (e) {
                          ...
                          return (
                              "rtl" === q(r || n).direction &&
                                  (s +=
                                      N(n.clientWidth, r ? r.clientWidth : 0) -
                                      o),
                              {
                                  width: o,
                                  height: a,
        ...
        function _e(e, t) {
            ...
            var n = t,
                ...
                P = (function (e, t, n, i) {
                    ...
                    L(S) ? S : S.contextElement || K(e.elements.popper),
                    m,
                    _,
                    u
                ),
                    ...
                    if (C) {
                        ...
                        if (d) {
                            var fe,
                                ...
                                ye = -1 !== [r, s].indexOf(k),
                                be =
                                    null != (fe = null == P ? void 0 : P[T])
                                        ? fe
                                        : 0,
                                we = ye
                                    ? me
                                    : pe - x[ve] - S[ve] - be + j.altAxis,
                                ke = ye
                                    ? pe + x[ve] + S[ve] - be - j.altAxis
                                    : ge,
                                Ee =
            ...
            gt = function (e, t) {
                if (
                    ...
                    t.addEventListener(nt, function n(r) {
                        r.target === t &&
                            ((i = !0), t.removeEventListener(nt, n), mt(e));
                    }),
                        setTimeout(function () {
                            i || rt(t);
                        }, n);
            ...
            off: function (e, t, n, i) {
                if ("string" == typeof t && e) {
                    ...
                    if (void 0 === a) {
                        if (f)
                            for (
                                var d = 0, h = Object.keys(l);
                                d < h.length;
                                d++
                            )
                                Pt(e, l, h[d], t.slice(1));
                        for (
                            var p = 0, v = Object.entries(u);
                            p < v.length;
                            p++
                        ) {
                            var m = Ye(v[p], 2),
                ...
                It.on(
                    ...
                    function (n) {
                        if (
                            ...
                            var r =
                                Kt.getElementFromSelector(this) ||
                                this.closest(".".concat(i));
                ...
                function t(e, n) {
                    ...
                    return (
                        ...
                        e && t.isSupported()
                            ? ((i._config = i._getConfig(n)),
                              (i._deltaX = 0),
                              (i._supportPointerEvents = Boolean(
                                  window.PointerEvent
                              )),
                              i._initEvents(),
                              i)
                                ...
                                value: function () {
                                    ...
                                    var r = {
                                        leftCallback: function () {
                                            return t._slide(
                                                t._directionToOrder(vn)
                                            );
                                        },
                                        rightCallback: function () {
                                            return t._slide(
                                                t._directionToOrder(mn)
                                            );
                                        },
                                ...
                                value: function () {
                                    ...
                                    if (
                                        ...
                                        if (
                                            ...
                                            (n.length &&
                                                n[0]._isTransitioning) ||
                                                It.trigger(this._element, Nn)
                                                    .defaultPrevented)
                                        ) {
                                            var i,
                                                r = $e(n);
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    if (this._config.parent) {
                                        var e,
                                            t = $e(
                                                this._getFirstLevelChildren(Vn)
                                            );
                                        try {
                                            for (t.s(); !(e = t.n()).done; ) {
                                                var n = e.value,
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    return (
                                        ...
                                        qe(
                                            qe({}, e),
                                            mt(this._config.popperConfig, [e])
                                        )
                                    );
                                },
                            },
                    ...
                    Ue(
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    return (
                                        (e.rootElement = at(e.rootElement)), e
                                    );
                                },
                            },
                            {
        ...
        It.on(document, hr, '[data-bs-toggle="offcanvas"]', function (e) {
            ...
            It.on(window, dr, function () {
                var e,
                    t = $e(
                        Kt.find("[aria-modal][class*=show][class*=offcanvas-]")
                    );
                try {
                    for (t.s(); !(e = t.n()).done; ) {
                        var n = e.value;
                        ...
                        [
                            {
                                ...
                                value: function () {
                                    ...
                                    return Object.values(this._config.content)
                                        .map(function (t) {
                                            return e._resolvePossibleFunction(
                                                t
                                            );
                                        })
                                        .filter(Boolean);
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    var a,
                                        s = e.children[0],
                                        c = this._resolvePossibleFunction(
                                            this._config.extraClass
                                        );
                                    return (
                                        c &&
                                            (a = s.classList).add.apply(
                                                a,
                                                Ge(c.split(" "))
                                            ),
                                        s
                    ...
                    Ue(
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    if (
                                        ...
                                        if (
                                            (this._getTipElement().classList.remove(
                                                xr
                                            ),
                                            "ontouchstart" in
                                                document.documentElement)
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    var t =
                                        this._getTemplateFactory(e).toHtml();
                                    if (!t) return null;
                                ...
                                value: function (e) {
                                    return (
                                        this._templateFactory
                                            ? this._templateFactory.changeContent(
                                                  e
                                              )
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    return (
                                        ...
                                        (this.tip &&
                                            this.tip.classList.contains(Cr))
                                    );
                                },
                            },
                            {
                                ...
                                value: function () {
                                    return (
                                        this.tip &&
                                        this.tip.classList.contains(xr)
                                    );
                                },
                            },
                            {
                                key: "_createPopper",
                                value: function (e) {
                                    var t = mt(this._config.placement, [
                                            this,
                                            e,
                                            this._element,
                                        ]),
                                        ...
                                        for (n.s(); !(e = n.n()).done; ) {
                                            ...
                                            if ("click" === i)
                                                It.on(
                                                    ...
                                                    function (e) {
                                                        t._initializeOnDelegatedTarget(
                                                            e
                                                        ).toggle();
                                                    }
                                                );
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    var e,
                                        t = $e(
                                            Kt.find(Kr, this._config.target)
                                        );
                                    try {
                                        for (t.s(); !(e = t.n()).done; ) {
                                            var n = e.value;
                    ...
                    Ue(
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    if (
                                        [oo, ao, so, co, lo, uo].includes(e.key)
                                    ) {
                                        e.stopPropagation(), e.preventDefault();
                                        var n,
                                            i = this._getChildren().filter(
                                                function (e) {
                                                    return !ct(e);
                                                }
                                            );
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    ...
                                    try {
                                        for (i.s(); !(n = i.n()).done; ) {
                                            var r = n.value;
                                            this._setInitialAttributesOnChild(
                                                r
                                            );
                                        }
                                    } catch (e) {

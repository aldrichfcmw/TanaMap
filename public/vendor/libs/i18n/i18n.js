                        ...
                        !(function (e) {
                            ...
                            try {
                                ...
                                (e.DOMException = function (t, e) {
                                    ...
                                    (e.DOMException.prototype = Object.create(
                                        Error.prototype
                                    )),
                                    (e.DOMException.prototype.constructor =
                                        e.DOMException);
                            }
                            function O(t, n) {
        ...
        return (
            (function () {
                ...
                function l(t, e, o) {
                    ...
                    const r =
                        "string" != typeof e ? [].concat(e) : e.split(".");
                    for (; r.length > 1; ) {
                        if (i()) return {};
                        const e = n(r.shift());
                        !t[e] && o && (t[e] = new o()),
                    ...
                    return i() ? {} : { obj: t, k: n(r.shift()) };
                }
                function u(t, e, o) {
                    const { obj: n, k: i } = l(t, e, Object);
                    n[i] = o;
                }
                function c(t, e) {
                ...
                function y(t, e) {
                    ...
                    for (let t = 0; t < n.length; ++t) {
                        if (!i) return;
                        if ("string" == typeof i[n[t]] && t + 1 < n.length)
                            return;
                        if (void 0 === i[n[t]]) {
                            let r = 2,
                                s = n.slice(t, t + r).join(o),
                                a = i[s];
                            for (; void 0 === a && n.length > t + r; )
                                r++,
                                    (s = n.slice(t, t + r).join(o)),
                                    (a = i[s]);
                            if (void 0 === a) return;
                ...
                class v extends n {
                    ...
                    getResource(t, e, o) {
                        ...
                        o && "string" != typeof o && (s = s.concat(o)),
                            o &&
                                "string" == typeof o &&
                                (s = s.concat(i ? o.split(i) : o)),
                            t.indexOf(".") > -1 && (s = t.split("."));
                        const a = c(this.data, s);
                        return a || !r || "string" != typeof o
                            ? a
                            : y(
                                  this.data && this.data[t] && this.data[t][e],
                                  o,
                                  i
                              );
                    }
                    addResource(t, e, o, n) {
                        ...
                        const r =
                            void 0 !== i.keySeparator
                                ...
                                : this.options.keySeparator;
                        let s = [t, e];
                        o && (s = s.concat(r ? o.split(r) : o)),
                            t.indexOf(".") > -1 &&
                                ((s = t.split(".")), (n = e), (e = s[1])),
                            this.addNamespaces(e),
                            u(this.data, s, n),
                            i.silent || this.emit("added", t, e, o, n);
                    }
                    addResources(t, e, o) {
                        let n =
                            arguments.length > 3 && void 0 !== arguments[3]
                        ...
                        for (const n in o)
                            ("string" != typeof o[n] &&
                                "[object Array]" !==
                                    Object.prototype.toString.apply(o[n])) ||
                    ...
                    addResourceBundle(t, e, o, n, i) {
                        ...
                        n ? h(a, o, i) : (a = { ...a, ...o }),
                            u(this.data, s, a),
                            r.silent || this.emit("added", t, e, o);
                    }
                ...
                class x extends n {
                    ...
                    translate(t, e, o) {
                        ...
                        if (l && "cimode" === l.toLowerCase()) {
                            if (u) {
                                const t =
                                    e.nsSeparator || this.options.nsSeparator;
                                return n
                                    ? {
                                          res: `${a}${t}${r}`,
                                          usedKey: r,
                        ...
                        if (
                            ...
                            (h = h.join(g)),
                                h && (h = this.extendTranslation(h, t, e, o));
                        else {
                            let n = !1,
                                s = !1;
                            const u =
                                ...
                                y =
                                    ...
                                    e[`defaultValue${d}`] ||
                                    e.defaultValue;
                            !this.isValidLookup(h) && p && ((n = !0), (h = y)),
                                this.isValidLookup(h) || ((s = !0), (h = r));
                            const m =
                            ...
                            (h = this.extendTranslation(h, t, e, c, o)),
                                s &&
                                    h === r &&
                    ...
                    extendTranslation(t, e, o, n, i) {
                        ...
                        if (this.i18nFormat && this.i18nFormat.parse)
                            ...
                            let l =
                                o.replace && "string" != typeof o.replace
                                    ? o.replace
                                    : o;
                            if (
                ...
                class E {
                    ...
                    getRule(t) {
                        ...
                        return (
                            this.rules[t] ||
                            this.rules[
                                this.languageUtils.getLanguagePartFromCode(t)
                            ]
                        );
                    }
                    needsPlural(t) {
                        ...
                        return this.shouldUseIntlApi()
                            ? o &&
                                  o.resolvedOptions().pluralCategories.length >
                                      1
                ...
                class N {
                        ...
                        (this.escape = void 0 !== e.escape ? e.escape : d),
                            ...
                            (this.nestingOptionsSeparator =
                                e.nestingOptionsSeparator
                                    ? e.nestingOptionsSeparator
                                    : e.nestingOptionsSeparator || ","),
                            (this.maxReplaces = e.maxReplaces
                                ? e.maxReplaces
                                : 1e3),
                            (this.alwaysFormat =
                    ...
                    nest(t, e) {
                        ...
                        for (; (o = this.nestingRegexp.exec(t)); ) {
                            ...
                            (i = { ...r }),
                                (i =
                                    i.replace && "string" != typeof i.replace
                                        ? i.replace
                                        : i),
                ...
                class A {
                    ...
                    format(t, e, o) {
                        ...
                        return e.split(this.formatSeparator).reduce((t, e) => {
                            const { formatName: i, formatOptions: r } =
                                (function (t) {
                            ...
                            return (
                                this.logger.warn(
                                    `there was no format function for ${i}`
                                ),
                                t
                            );
                        }, t);
                ...
                class $ extends n {
                    constructor(t, e, n) {
                        ...
                        super(),
                            ...
                            (this.readingCalls = 0),
                            (this.maxRetries =
                                i.maxRetries >= 0 ? i.maxRetries : 5),
                            (this.retryTimeout =
                                i.retryTimeout >= 1 ? i.retryTimeout : 350),
                            (this.state = {}),
                            (this.queue = []),
                            this.backend &&
                                this.backend.init &&
                        ...
                        return (
                            t.forEach((t) => {
                                ...
                                e.forEach((e) => {
                                    const s = `${t}|${e}`;
                                    !o.reload &&
                                    this.store.hasResourceBundle(t, e)
                                        ? (this.state[s] = 2)
                                        : this.state[s] < 0 ||
                                          (1 === this.state[s]
                                              ? void 0 === r[s] && (r[s] = !0)
                    ...
                    loaded(t, e, o) {
                        ...
                        e && this.emit("failedLoading", i, r, e),
                            o && this.store.addResourceBundle(i, r, o),
                            (this.state[t] = e ? -1 : 2);
                        const s = {};
                    ...
                    loadOne(t) {
                        ...
                        this.read(n, i, "read", void 0, void 0, (o, r) => {
                            o &&
                                this.logger.warn(
                                    `${e}loading namespace ${i} for language ${n} failed`,
                                    o
                                ),
                                !o &&
                                    r &&
                                    this.logger.log(
                                        `${e}loaded namespace ${i} for language ${n}`,
                                        r
                                    ),
                                this.loaded(t, o, r);
                        });
                ...
                function I(t) {
                    return (
                        ...
                        "string" == typeof t.fallbackNS &&
                            (t.fallbackNS = [t.fallbackNS]),
                        t.supportedLngs &&
                            t.supportedLngs.indexOf("cimode") < 0 &&
                            (t.supportedLngs = t.supportedLngs.concat([
                                "cimode",
                            ])),
                        t
                    );
                ...
                class F extends n {
                    ...
                    use(t) {
                        ...
                        return (
                            ...
                            "i18nFormat" === t.type &&
                                (this.modules.i18nFormat = t),
                            "postProcessor" === t.type && b.addPostProcessor(t),
                            "formatter" === t.type &&
                                (this.modules.formatter = t),
                            "3rdParty" === t.type &&
                                this.modules.external.push(t),
                            this
                        );
                    }
                    ...
                    getFixedT(t, e, o) {
                        ...
                        const i = function (t, e) {
                            ...
                            (r.lng = r.lng || i.lng),
                                ...
                                (r.ns = r.ns || i.ns),
                                (r.keyPrefix = r.keyPrefix || o || i.keyPrefix);
                    ...
                    t() {
                        return (
                            this.translator &&
                            this.translator.translate(...arguments)
                        );
                    }
                    exists() {
                        return (
                            this.translator &&
                            this.translator.exists(...arguments)
                        );
                    }
                    ...
                    cloneInstance() {
                        ...
                        return (
                            ...
                            (i.services.utils = {
                                hasLoadedNamespace:
                                    i.hasLoadedNamespace.bind(i),
                            }),
                            o &&
                                ((i.store = new v(this.store.data, n)),
                                (i.services.resourceStore = i.store)),
                            (i.translator = new x(i.services, n)),
                ...
                function q(t) {
                    return (
                        H.call(V.call(arguments, 1), function (e) {
                            if (e)
                                for (var o in e)
                                    void 0 === t[o] && (t[o] = e[o]);
                        }),
                                    ...
                                    "function" ==
                                        ...
                                        (a = (function (t) {
                                            ...
                                            function (r) {
                                                if (!r) return i(null, {});
                                                var a =
                                                    s.services.interpolator.interpolate(
                                                        r,
                                                        {
                                                            lng: t.join("+"),
                                                            ns: o.join("+"),
                            ...
                            },
                            {
                                ...
                                value: function (t, e, o, n, i) {
                                    ...
                                    if (this.options.addPath) {
                                        "string" == typeof t && (t = [t]);
                                        var s = this.options.parsePayload(
                                                e,
                                                o,
                                                n
                                            ),
                                        ...
                                        t.forEach(function (o) {
                                            ...
                                            "function" ==
                                                typeof r.options.addPath &&
                                                (n = r.options.addPath(o, e));
                                            var c =
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    if (!r || "cimode" !== r.toLowerCase()) {
                                        var s = [],
                                            a = function (t) {
                                                n.toResolveHierarchy(t).forEach(
                                                    function (t) {
                                                        s.indexOf(t) < 0 &&
                                                            s.push(t);
                                                    }
                ...
                var ct = [],
                                    ...
                                    o &&
                                        ...
                                        (document.cookie = (function (t, e, o) {
                                            ...
                                            if (n.expires) {
                                                if (
                                                    "function" !=
                                                    typeof n.expires.toUTCString
                                                )
                                                    throw new TypeError(
                                                        "option expires is invalid"
                                                    );
                                                r += "; Expires=".concat(
                                                    n.expires.toUTCString()
                                                );
                                            }
                                            if (
                                                (n.httpOnly &&
                    ...
                    xt = {
                        ...
                        lookup: function (t) {
                            ...
                            if (t.lookupSessionStorage && wt()) {
                                var o = window.sessionStorage.getItem(
                        ...
                        lookup: function (t) {
                            ...
                            if ("undefined" != typeof navigator) {
                                if (navigator.languages)
                                    for (
                                        var o = 0;
                                        o < navigator.languages.length;
                                        o++
                                    )
                                        e.push(navigator.languages[o]);
                                navigator.userLanguage &&
                                    e.push(navigator.userLanguage),
                                    navigator.language &&
                        ...
                        lookup: function (t) {
                            ...
                            if ("undefined" != typeof window) {
                                ...
                                if (o instanceof Array)
                                    if (
                                        "number" == typeof t.lookupFromPathIndex
                                    ) {
                                        if (
                                            "string" !=
                                            typeof o[t.lookupFromPathIndex]
                                        )
                                            return;
                    ...
                    Lt = {
                        ...
                        lookup: function (t) {
                            var e =
                                    "number" ==
                                    typeof t.lookupFromSubdomainIndex
                                    ...
                                    value: function (t) {
                                        ...
                                        (this.services = t || {
                                            ...
                                            "string" ==
                                                ...
                                                (this.options.convertDetectedLanguage =
                                                    function (t) {
                                                        return t.replace(
                                                            "-",
                                                            "_"
                                ...
                                },
                                {
                                    ...
                                    value: function (t) {
                                        ...
                                        return (
                                            ...
                                            (o = o.map(function (t) {
                                                return e.options.convertDetectedLanguage(
                                                    t
                                                );
                                            })),
                                            this.services.languageUtils

                ...
                8764: function (t) {
                    (t.exports = (function () {
                        ...
                        var b = {},
                            ...
                            z = function () {
                                return I(
                                    ".".concat(C.actions, " .").concat(C.cancel)
                                );
                            },
                            W = function () {
                                return I(
                                    ".".concat(C.actions, " .").concat(C.deny)
                                );
                            },
                            K = function () {
                            ...
                            X = function () {
                                ...
                                return d(new Set(n.concat(i))).filter(function (
                                    t
                                ) {
                                    return vt(t);
                                });
                            ...
                            ut = function (t, e) {
                                for (
                                    var n = Array.from(t.children), o = 0;
                                    o < n.length;
                                    o++
                                ) {
                                    var i = n[o];
                        ...
                        var Ot = {
                            ...
                            It = function (t) {
                                var e = qt(t.input);
                                "object" === o(t.customClass) &&
                                    at(e, t.customClass.input);
                            },
                            Ht = function (t, e) {
                        ...
                        var xn,
                            ...
                            Sn = Object.freeze({
                                ...
                                getTimerLeft: function () {
                                    return (
                                        b.timeout && b.timeout.getTimerLeft()
                                    );
                                },
                                getTimerProgressBar: $,
                                getTitle: V,
                                ...
                                isLoading: function () {
                                    var t = D();
                                    return (
                                        !!t && t.hasAttribute("data-loading")
                                    );
                                },
                                isTimerRunning: function () {
                                    return !(
                                        !b.timeout || !b.timeout.isRunning()
                                    );
                                },
                        ...
                        function Yn(t) {
                            (function (t) {
                                t.inputValidator ||
                                    ("email" === t.input &&
                                        (t.inputValidator = Kn.email),
                                    "url" === t.input &&
                                        (t.inputValidator = Kn.url));
                            })(t),

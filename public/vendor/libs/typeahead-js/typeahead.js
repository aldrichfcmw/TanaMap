                        ...
                        (r = function (t) {
                            return (s.Bloodhound =
                                ...
                                (o = (function () {
                                    "use strict";
                                    function t(t) {
                                        (this.maxSize = n.isNumber(t)
                                            ? t
                                            : 100),
                                            this.reset(),
                                            this.maxSize <= 0 &&
                                                (this.set = this.get = e.noop);
                                    }
                                    function i() {
                                ...
                                (a = (function () {
                                    ...
                                    return (
                                        (u.setMaxPendingRequests = function (
                                            t
                                        ) {
                                            r = t;
                                        }),
                                    ...
                                    return function (r) {
                                        ...
                                        return (
                                            ...
                                            !(r = n.mixin(s, r || {}))
                                                .datumTokenizer &&
                                                e.error(
                                                    "datumTokenizer is required"
                                                ),
                                            !r.queryTokenizer &&
                                                e.error(
                                                    "queryTokenizer is required"
                                                ),
                                            (o = r.sorter),
                                            (r.sorter = o
                                                ? function (t) {
                                        ...
                                        n.mixin(i.prototype, {
                                            ...
                                            _loadPrefetch: function () {
                                                ...
                                                return (
                                                    ...
                                                    this.prefetch
                                                        ? (n =
                                                              this.prefetch.fromCache())
                                                            ? (this.index.bootstrap(
                                                                  n
                                                              ),
                                                              t.resolve())
                                                            : this.prefetch.fromNetwork(
                                                                  function (
                                                                      e,
                                                                      n
                                                                  ) {
                            ...
                            return (
                                ...
                                (u = (function () {
                                    ...
                                    function i(t, i) {
                                        var r;
                                        (t = t || {}).input ||
                                            e.error("input is missing"),
                                            i.mixin(this),
                                            (this.$hint = e(t.hint)),
                                            (this.$input = e(t.input)),
                                            (this.query = this.$input.val()),
                                            (this.queryWhenFocused =
                                                this.hasFocus()
                                                    ? this.query
                                                    : null),
                                            (this.$overflowHelper =
                                            ...
                                            isCursorAtEnd: function () {
                                                ...
                                                return (
                                                    ...
                                                    n.isNumber(e)
                                                        ...
                                                        : !document.selection ||
                                                          ((i =
                                                              document.selection.createRange()).moveStart(
                                                              "character",
                                                              -t
                                                          ),
                                                          t === i.text.length)
                                        ...
                                        ((t = t || {}).templates =
                                            ...
                                            (this.templates = (function (t, i) {
                                                return {
                                                    ...
                                                    pending:
                                                        t.pending &&
                                                        n.templatify(t.pending),
                                                    header:
                                                        t.header &&
                                                        n.templatify(t.header),
                                                    footer:
                                                        t.footer &&
                                                        n.templatify(t.footer),
                                                    suggestion:
                                                        t.suggestion || r,
                                                };
                                                function r(t) {
                                ...
                                (l = (function () {
                                    ...
                                    function t(t, r) {
                                        ...
                                        (t = t || {}).input ||
                                            e.error("missing input"),
                                            t.menu || e.error("missing menu"),
                                            t.eventBus ||
                                                e.error("missing event bus"),
                                            r.mixin(this),
                                            (this.eventBus = t.eventBus),
                                            (this.minLength = n.isNumber(
                                                t.minLength
                                            )
                                                ? t.minLength
                                                : 1),
                                    ...
                                    return (
                                        n.mixin(t.prototype, {
                                            ...
                                            _onLangDirChanged: function (t, e) {
                                                this.dir !== e &&
                                                    ((this.dir = e),
                                                    this.menu.setLanguageDirection(
                                                        e
                                                    ));
                                            },
                                            ...
                                            moveCursor: function (t) {
                                                ...
                                                return (
                                                    (e = this.input.getQuery()),
                                                    (n =
                                                        this.menu.selectableRelativeToCursor(
                                                            t
                                                        )),
                                                    (r = (i =
                                                        this.menu.getSelectableData(
